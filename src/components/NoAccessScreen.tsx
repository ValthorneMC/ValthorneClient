          ...
          <div className="glass-card rounded-3xl p-12 text-center space-y-8 animate-slide-up">
            ...
            <div className="space-y-4">
              <div className="flex justify-center">
                <div className="w-20 h-20 rounded-full bg-gradient-to-br from-[#7c4dbd]/20 to-[#d4af37]/20 border-2 border-[#7c4dbd]/30 flex items-center justify-center">
                  <svg
                    className="w-10 h-10 text-[#7c4dbd]"
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                  >
            ...
            <div className="pt-4">
              <Button
                onClick={onLogout}
                className="font-heading bg-gradient-to-r from-[#7c4dbd]/20 to-[#5b3690]/20 hover:from-[#7c4dbd]/30 hover:to-[#5b3690]/30
                         text-white border-2 border-[#7c4dbd]/40 hover:border-[#7c4dbd]/60
